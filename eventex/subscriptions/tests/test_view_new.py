...
class SubscriptionsNewGetTest(TestCase):
    def setUp(self):
...
class SubscriptionsNewPostValidTest(TestCase):
    def setUp(self):
        data = dict(
...
class SubscriptionsNewPostInvalidPost(TestCase):
    def setUp(self):
...
class TemplateRegressionTest(TestCase):
    def test_template_has_non_field_error(self):
        invalid_data = dict(name='Marcos Vinicios', cpf='12345678901')
